...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { fase: @calendar.fase, fecha: @calendar.fecha, hora: @calendar.hora, stadium_id: @calendar.stadium_id } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { fase: @calendar.fase, fecha: @calendar.fecha, hora: @calendar.hora, stadium_id: @calendar.stadium_id } }
